...
function ChangePhoneAndEmail() {
  ...
  return (
    <div className="flex flex-col w-full gap-4 m-10 items-center">
      <h1 className="text-3xl font-semibold">Change Contacts</h1>

      <div className="border border-gray-300 rounded-2xl py-3 px-7 mt-5 bg-emerald-50 w-full max-w-lg">
        <div>
      ...
      <button
        onClick={handleSave}
        className="border border-gray-400 rounded px-5 py-1 bg-green-700 text-white hover:bg-green-200 hover:text-black"
      >
        Save
      </button>
    </div>
